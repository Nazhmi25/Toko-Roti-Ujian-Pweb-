...
<div class="container">
    ...
    <td>Nama</td>
    <td>
        <?php echo isset($t_cs['nama']) ? $t_cs['nama'] : 'Data tidak tersedia'; ?>
    </td>
</tr>
<tr>
    <td>Alamat</td>
    <td>
        <?php 
        echo isset($t_order['alamat'], $t_order['kota'], $t_order['provinsi'], $t_order['kode_pos']) 
            ? $t_order['alamat'] . "," . $t_order['kota'] . " " . $t_order['provinsi'] . "," . $t_order['kode_pos'] 
            : 'Data tidak tersedia'; 
        ?>
    </td>
</tr>
<tr>
    <td>No Telp</td>
    <td>
        <?php echo isset($t_cs['telp']) ? $t_cs['telp'] : 'Data tidak tersedia'; ?>
    </td>
</tr>
